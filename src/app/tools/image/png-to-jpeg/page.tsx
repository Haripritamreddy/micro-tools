//src/app/tools/image/png-to-jpeg/page.tsx
'use client';
...
export default function PngToJpeg() {
          ...
          reader.onload = () => {
            ...
            img.onload = () => {
              ...
              if (ctx) {
                ctx.drawImage(img, 0, 0);
                const jpegUrl = canvas.toDataURL('image/jpeg');
                zip.file(file.name.replace('.png', '.jpeg'), jpegUrl.split(',')[1], { base64: true });
                resolve(null);
              }
            };
          };
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4 text-center">PNG to JPEG Converter</h1>
      ...
      >
        ...
        <label htmlFor="fileInput">
          <p>Drag and Drop your PNG files here or </p> 
          <p>click to browse.</p>
        </label>
      </div>
