// src/app/tools/image/webp-to-jpeg/page.tsx
'use client';
...
export default function WebpToJpeg() {
      ...
      reader.onload = () => {
        ...
        img.onload = () => {
          ...
          if (ctx) {
            ...
            link.download = file.name.replace('.webp', '.jpeg');
            link.href = jpegUrl;
            link.click();
          }
        };
          ...
          reader.onload = () => {
            ...
            img.onload = () => {
              ...
              if (ctx) {
                ctx.drawImage(img, 0, 0);
                const jpegUrl = canvas.toDataURL('image/jpeg');
                zip.file(file.name.replace('.webp', '.jpeg'), jpegUrl.split(',')[1], { base64: true });
                resolve(null);
              }
            };
          };
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4 text-center">WEBP to JPEG Converter</h1>
      ...
      >
        ...
        <label htmlFor="fileInput">
          <p>Drag and Drop your WEBP files here or </p>
          <p>click to browse.</p>
        </label>
      </div>
